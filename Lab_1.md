...
**Тип 1 ("Bare-Metal" або "Залізний"):**
    <br>- Встановлюється безпосередньо на апаратне забезпечення сервера без основної операційної системи.
    <br>- **Переваги:** Висока продуктивність, стабільність.
    <br>- **Приклади:** Xen, VMware ESXi, Microsoft Hyper-V (у режимi сервера).
**Тип 2 ("Hosted" або "Хостовий"):**
    <br>- Встановлюється як звичайна програма на існуючу операційну систему (Windows, Linux, macOS).
    <br>- **Переваги:** Простота налаштування, підходить для домашнього використання.
    <br>- **Приклади:** Oracle VirtualBox, VMware Workstation.
