...
| Графічна оболонка | Тип | Характеристика |
| :--- | :--- | :--- |
| **Gnome** (GNU Network Object Model Environment) | Повноцінне середовище робочого столу (Desktop Environment) | Одне з найпопулярніших середовищ (дефолтне для Ubuntu, Fedora). Має сучасний, мінімалістичний дизайн, орієнтований на простоту та продуктивність. Використовує власні бібліотеки GTK+. Вимагає наявності 3D-прискорення та споживає відносно багато системних ресурсів (RAM/CPU). Підходить для сучасних ПК. |
| **JWM** (Joe's Window Manager) | Менеджер вікон (Window Manager) | Надзвичайно легкий та швидкий менеджер вікон для X Window System. Написаний на C, використовує мінімум бібліотек. Споживає дуже мало пам'яті, ідеально підходить для старого обладнання або портативних систем (наприклад, використовується в Puppy Linux). Має класичний вигляд (панель завдань, меню "Пуск"), налаштовується через XML-файли. |
