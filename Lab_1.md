...
####**Викноав студент групи РПЗ-33 Тихий Андрій**
##**Тема:** 
...
**Hypervisor** - Програмне забезпечення, яке створює та запускає віртуальні машини[cite: 205].<br>
**Host OS** - Операційна система фізичного комп'ютера, на якій працює гіпервізор (типу 2)[cite: 223].<br>
**Guest OS** - Операційна система, яка встановлена всередині віртуальної машини[cite: 225].<br>
